...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *VClusterSpecChart) DeepCopyInto(out *VClusterSpecChart) {
	*out = *in
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new VClusterSpecChart.
func (in *VClusterSpecChart) DeepCopy() *VClusterSpecChart {
	if in == nil {
		return nil
	}
	out := new(VClusterSpecChart)
	in.DeepCopyInto(out)
	return out
}
